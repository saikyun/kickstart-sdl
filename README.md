...
2. (Optional) Change Terminal startup directory, see (Change default startup directory in Terminal)[[#change-default-startup-directory-in-terminal](https://github.com/saikyun/sdl-lessons#change-default-startup-directory-in-terminal)]
